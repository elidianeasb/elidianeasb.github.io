  ...
  const cards = [
    {
      ...
      subjects: [
        ...
        },
        {
          ...
          content:
            "Program promoted by the Lisbon City Council. I was one of the five finalists, out of an initial group of 700, to won a scholarship at Le Wagon's bootcamp.",
        },
        {
          name: "Fullstack Web Development - Lisbon | Oct 2022 - Dez 2022",
          content:
            "Web Development Bootcamp program based on MERN Stack: *• Frontend: HTML, CSS, and JavaScript, Bootstrap, React. *• Backend: NodeJS, ExpressJS, MongoDB, NodeJS, MongoDB, Axios.",
        },
        {
    ...
    },
    {
      ...
      subjects: [
        {
          name: "Software Developer - Rauva | Lisbon - Sep 2021 - Present",
          content:
            "Developed and deployed scalable mobile applications using React Native and Expo for both iOS and Android platforms.",
        },
      ],
    },
    {
      ...
      <div className="container cards">
        <div className="experience__cards">
          ...
          <div className="experience__content">
            {activeIndex !== null &&
              cards[activeIndex].subjects.map((subject, subIndex) => (
                <div key={subIndex}>
                  <h3>{subject.name}</h3>
